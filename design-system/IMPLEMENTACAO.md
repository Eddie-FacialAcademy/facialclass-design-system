...
```
repo (facialclass-design-system)
...
└── design-system/                   # PACOTE consumível
    ...
    ├── facial-design-system.css     # DROP-IN: tokens + reset + foco + motion + tipografia + botões + chips/status
    ├── facial-design-tokens.json    # Tokens legíveis por máquina (Framer, Style Dictionary-like, IA)
    ...
    └── copy-deck.facial.json        # Strings de produto do showcase
```
...
### 2.5 Formato do `facial-design-tokens.json`
...
<html lang="pt-BR"><head>
  ...
  <link rel="stylesheet" href="facial-design-system.css">
</head><body>
...
| Aspecto | Facial Class | Corporal Class |
|---|---|---|
| Arquivos | `facial-design-system.css` · `facial-design-tokens.json` · `copy-deck.facial.json` | `corporal-design-system.css` · `corporal-design-tokens.json` · `copy-deck.corporal.json` |
...
| Marca / Academy | Facial Class / Facial Academy | Corporal Class / Corporal Academy |
