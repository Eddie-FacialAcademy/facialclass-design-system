...
- **URL pública:** https://edegardesignacademy-hash.github.io/facialclass-design-system/
- Repo público `facialclass-design-system` (conta `edegardesignacademy-hash`), branch `main`, `index.html` na raiz.
